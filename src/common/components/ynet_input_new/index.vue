<template>
  <div class="ynet-input-new"
@click.stop>
    <div v-if="errMsg" class="ynet-input__errMsg">
{{ errMsg }}
</div>
    <div class="ynet-input__title"
:class="{ 'red-star': redStar }" v-else>
      <label>
        {{ title }}
    ...
    <div style="display: flex;">
      ...
      >
        ...
        >
          ...
          <div
            v-html="
              maskCurrentValue ? maskCurrentValue : currentValue
            "
            :class="
              leftInput
