<template>
    <div class="financingProduct__style">
        ...
        <div class="cut__off__ule" v-if="styleType == '01'">
            <span>分割线</span>
        ...
        <div class="cut__off__ule" v-if="styleType == '02'">
            <span>进度条</span>
            <el-input :disabled="!isSplitBtnJ" v-model="divlineColor" @change="updataOptions"></el-input>
            <div @click="isSplitBtnEventJ" class="splitBtn" :class="[isSplitBtnJ ? 'splitBtn__active' : '']">
                <div class="splitRadio" :class="[isSplitBtnJ ? 'splitRadio__active' : '']"></div>
            </div>
        </div>
        <div class="financingProduct" v-if="styleType == '01'">
            <span>说明样式</span>
        ...
        <el-dialog title="从理财列表中导入" :visible.sync="dialogFormVisible" :before-close="hideDialog">
            <regular-product ref="productList" @backMenu="backMenu"/>
...
import regularProduct from '../components/popup/regularProduct'
import linkPanel from '../components/popup/linkPanel'
export default {
    components: {
        regularProduct, linkPanel
    },
    data() {
        return {
    ...
    watch: {
        flag(nval) {
            ...
            switch(nval) {
                ...
                break;
                case '01':
                this.heightF = 108 * this.contentList.length +''
                break;
            }
        },
    ...
    methods: {
        ...
        editFloorStyleAllocation() {
            let productData = {
                ...
                isProgressBar: this.isSplitBtnJ ? '1' : '0',
                divlineType: '0',
        ...
        eidtMenuStyleRpc() {
            ...
            this.contentList.forEach((item, index) => {
                ...
                regularBasisList.push({
                    ...
                    fieldset3: '年化收益率',
                    fieldset6: item.initialAmt.split('.')[0],
                    fieldset7: '起投金额',
                    fieldset5: '理财期限',
            ...
            let productStyleDate = {
                ...
                pageId: this.options.pageId,
                floorType: '09',
                regularBasisList: regularBasisList
            }
        ...
        isSplitBtnEventJ() {
            this.isSplitBtnJ = !this.isSplitBtnJ
            this.updataOptions()
        },
        // 数据面板更新data
        updataOptions() {
            ...
            this.menuOptions = {
                ...
                widthF: '375',
                heightF: this.heightF,
                styleInfoList: regularBasisList
            }
